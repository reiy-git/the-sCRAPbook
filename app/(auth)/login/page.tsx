...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-grid-pattern grid md:grid-cols-10">
      <aside className="hidden md:flex md:col-span-6 items-end p-12">
        <div>
          <p className="text-sm font-extrabold tracking-[0.4em] uppercase text-[#F0625A]">Reiy</p>
      ...
      <main className="md:col-span-4 min-h-screen border-t-4 md:border-t-0 md:border-l-4 border-[#111] bg-[#FAF8F5] grid content-center px-8 py-16">
        <header className="mb-8">
          <h2 className="text-5xl font-extrabold uppercase tracking-tight">Login</h2>
          <p className="font-semibold mt-2 text-[#111]/60">Drop in. Write All.</p>
        </header>
        ...
        <p className="mt-6 font-bold">
          New here?{" "}
          <Link href="/signup" className="underline decoration-4 decoration-[#F0625A]">
            Create an account
          </Link>
        </p>
      </main>
